...
var hljs = (function () {
  ...
  const U = {},
    ...
    X = (e, t) => {
      U[`${e}/${t}`] ||
        (console.log(`Deprecated as of ${e}. ${t}`), (U[`${e}/${t}`] = !0));
    },
    G = Error();
  ...
  const J = n,
    ...
    ee = (n) => {
      ...
      function E(e, n, s, r) {
        ...
        const w = O(e);
        if (!w)
          throw (z(a.replace("{}", e)), Error('Unknown language: "' + e + '"'));
        const v = Z(w);
        let k = "",
          N = r || v;
        const S = {},
        ...
        let R = "",
          ...
          T = !1;
        try {
          if (w.emitTokens) w.emitTokens(n, M);
          else {
...
"object" == typeof exports &&
  ...
  (module.exports =
    hljs); /*! `bash` grammar compiled for Highlight.js 11.11.1 */
(() => {
  var e = (() => {
    "use strict";
    return (e) => {
      ...
      return {
        ...
        contains: [
          ...
          },
          {
            ...
            variants: [
              {
                match: e.concat(t, E, a),
              },
              { begin: e.concat(E, a), "on:begin": c },
            ],
          },
          {
            scope: "params",
            variants: [
              { match: e.concat(t, d, a) },
              { begin: e.concat(d, a), "on:begin": c },
            ],
          },
        ],
      };
