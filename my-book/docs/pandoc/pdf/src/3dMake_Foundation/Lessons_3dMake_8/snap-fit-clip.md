[Header 3 ("3dmake_foundation_lessons_3dmake_8-snap-fit-clip", [], []) [Str "Snap-Fit Clip Project"], Header 4 ("starter-code", ["unnumbered", "unlisted"], []) [Str "Starter Code"], Para [Str "Use this stackable bins example as your starting point:"], CodeBlock ("", ["openscad"], []) "// Stackable Storage Bins - Advanced Example
// Parameters
binw = 80;      // width
bind = 120;     // depth
binh = 60;      // height
