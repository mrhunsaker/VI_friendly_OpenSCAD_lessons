[Header 3 ("3dmake_foundation_lessons_3dmake_10-diagnostic_checklist", [], []) [Str "Diagnostic Checklist for 3D Printing"], Para [Str "Use this comprehensive checklist to systematically diagnose and troubleshoot printing issues."], Header 4 ("quick-diagnosis-flowchart", ["unnumbered", "unlisted"], []) [Str "Quick Diagnosis Flowchart"], CodeBlock ("", ["plaintext"], []) "Print Problem?
|
+---- [Before Print] Issues?
...
", HorizontalRule, Header 4 ("pre-print-diagnostics", ["unnumbered", "unlisted"], []) [Str "Pre-Print Diagnostics"], Header 5 ("category-a-power--connectivity", ["unnumbered", "unlisted"], []) [Str "Category A: Power & Connectivity"], Para [Strong [Str "Checklist:"]], BulletList [[Plain [Str "\9744", Space, Str "Printer powered on"]], [Plain [Str "\9744", Space, Str "LED indicators showing normal status"]], [Plain [Str "\9744", Space, Str "USB cable connected (if applicable)"]], [Plain [Str "\9744", Space, Str "No error codes displaying"]], [Plain [Str "\9744", Space, Str "Display/interface responding to input"]]], Para [Strong [Str "If failed:"]], OrderedList (1, DefaultStyle, DefaultDelim) [[Plain [Str "Check power outlet and cable"]], [Plain [Str "Verify power supply specifications (voltage, current)"]], [Plain [Str "Test with different power outlet"]], [Plain [Str "Try power-cycling (off 30 sec, on)"]], [Plain [Str "Check for blown fuses inside printer"]]], HorizontalRule, Header 5 ("category-b-temperature-system", ["unnumbered", "unlisted"], []) [Str "Category B: Temperature System"], Para [Strong [Str "Heating Element Status:"]], BulletList [[Plain [Str "\9744", Space, Str "Hot end temperature rises when heating commanded"]], [Plain [Str "\9744", Space, Str "Bed temperature rises when heating commanded"]], [Plain [Str "\9744", Space, Str "Temperature readings stable (not fluctuating 5C+)"]], [Plain [Str "\9744", Space, Str "No error messages during heating"]]], Para [Strong [Str "Measurement Method:"]], CodeBlock ("", ["plaintext"], []) "1. Set hot end to 200C, observe rise
...
", Para [Strong [Str "If heating slow/incomplete:"]], BulletList [[Plain [Str "\9744", Space, Str "Verify target temperature was set"]], [Plain [Str "\9744", Space, Str "Check heating element firmware settings"]], [Plain [Str "\9744", Space, Str "Test thermal sensor connectivity"]], [Plain [Str "\9744", Space, Str "Inspect heating element for damage"]], [Plain [Str "\9744", Space, Str "Measure electrical resistance of heaters"]]], Para [Strong [Str "Temperature Stability Test:"]], CodeBlock ("", ["plaintext"], []) "1. Heat to target temperature
...
- +/-10C range:  Marginal
- >+/-10C range:  Problem
", HorizontalRule, Header 5 ("category-c-mechanical-systems", ["unnumbered", "unlisted"], []) [Str "Category C: Mechanical Systems"], Para [Strong [Str "Movement Diagnostics:"]], Para [Strong [Str "Manual Axis Movement:"]], CodeBlock ("", ["plaintext"], []) "1. Disable motors (if possible)
2. Manually move each axis
3. Record observations:
   - X-axis:  (smooth/rough/stuck)
   - Y-axis:  (smooth/rough/stuck)
   - Z-axis:  (smooth/rough/stuck)
", Para [Strong [Str "Expected results:"], Str " Smooth, no grinding sounds"], Para [Strong [Str "If rough/stuck:"]], BulletList [[Plain [Str "\9744", Space, Str "Check for visible obstructions"]], [Plain [Str "\9744", Space, Str "Inspect rails for debris"]], [Plain [Str "\9744", Space, Str "Verify pulleys turn freely"]], [Plain [Str "\9744", Space, Str "Check belt tension (if accessible)"]], [Plain [Str "\9744", Space, Str "Lubricate dry joints"]]], Para [Strong [Str "Powered Movement Test:"]], CodeBlock ("", ["plaintext"], []) "1. Position nozzle at center
2. Command X+10mm movement
3. Verify nozzle moved ~10mm
4. Repeat for Y+10mm and Z+5mm
5. Check for skipping or missed steps
", HorizontalRule, Header 5 ("category-d-leveling--alignment", ["unnumbered", "unlisted"], []) [Str "Category D: Leveling & Alignment"], Para [Strong [Str "Build Plate Leveling Test:"]], Para [Strong [Str "Paper Method (Most Common):"]], CodeBlock ("", ["plaintext"], []) "1. Heat bed to printing temperature
...
", Para [Strong [Str "Leveling Validation:"]], BulletList [[Plain [Str "\9744", Space, Str "Level at 4 corners"]], [Plain [Str "\9744", Space, Str "Level at bed center"]], [Plain [Str "\9744", Space, Str "No high/low points"]], [Plain [Str "\9744", Space, Str "Nozzle doesn't hit bed at any point"]], [Plain [Str "\9744", Space, Str "Consistent first-layer appearance across bed"]]], HorizontalRule, Header 5 ("category-e-filament--extruder", ["unnumbered", "unlisted"], []) [Str "Category E: Filament & Extruder"], Para [Strong [Str "Filament Quality Check:"]], BulletList [[Plain [Str "\9744", Space, Str "Filament diameter consistent (visually inspect ", Str "~", Str "50cm)"]], [Plain [Str "\9744", Space, Str "No visible cracks or damage"]], [Plain [Str "\9744", Space, Str "Spool rotates freely without binding"]], [Plain [Str "\9744", Space, Str "Filament path clear to extruder"]], [Plain [Str "\9744", Space, Str "No tangles in filament path"]]], Para [Strong [Str "Extruder Test:"]], CodeBlock ("", ["plaintext"], []) "1. Heat to printing temperature
...
", HorizontalRule, Header 4 ("filament-loading-test", ["unnumbered", "unlisted"], []) [Str "Filament Loading Test"], Para [Strong [Str "Test Sequence:"]], CodeBlock ("", ["plaintext"], []) "1. Heat extruder to material temp
...
", HorizontalRule, Header 5 ("mechanical-issue-diagnostics", ["unnumbered", "unlisted"], []) [Str "Mechanical Issue Diagnostics"], Para [Strong [Str "When movement sounds wrong:"]], Para [Strong [Str "Listen for:"]], BulletList [[Plain [Str "Grinding/grating: Bearing issue or obstruction"]], [Plain [Str "Clicking/skipping: Lost steps or over-torque"]], [Plain [Str "Squealing: Lubrication needed"]], [Plain [Str "Silence (but no movement): Stalled motor"]]], Para [Strong [Str "Diagnosis Method:"]], CodeBlock ("", ["plaintext"], []) "1. Pause print
...
", HorizontalRule, Header 4 ("layer-quality-diagnostics", ["unnumbered", "unlisted"], []) [Str "Layer Quality Diagnostics"], Header 5 ("visual-inspection-during-print", ["unnumbered", "unlisted"], []) [Str "Visual Inspection During Print"], Para [Strong [Str "Every 30 minutes of printing, check:"]], CodeBlock ("", ["plaintext"], []) "[ ] Layer alignment (no X/Y shifting)
...
", HorizontalRule, Header 4 ("dimensional-accuracy-diagnostics", ["unnumbered", "unlisted"], []) [Str "Dimensional Accuracy Diagnostics"], Para [Strong [Str "After print completes and cools (24 hours):"]], Header 5 ("precision-measurement", ["unnumbered", "unlisted"], []) [Str "Precision Measurement"], Para [Strong [Str "Materials Needed:"]], BulletList [[Plain [Str "Digital calipers (+/-0.05mm accuracy)"]], [Plain [Str "Ruler (for larger dimensions)"]], [Plain [Str "Notepad for recording"]]], Para [Strong [Str "Measurement Protocol:"]], CodeBlock ("", ["plaintext"], []) "1. Measure each dimension 3 times at different locations
2. Calculate average
...
", Header 5 ("tolerance-evaluation", ["unnumbered", "unlisted"], []) [Str "Tolerance Evaluation"], Table ("", [], []) (Caption Nothing []) [(AlignDefault, ColWidthDefault), (AlignDefault, ColWidthDefault), (AlignDefault, ColWidthDefault)] (TableHead ("", [], []) [Row ("", [], []) [Cell ("", [], []) AlignDefault (RowSpan 0) (ColSpan 0) [Plain [Str "Tolerance"]], Cell ("", [], []) AlignDefault (RowSpan 0) (ColSpan 0) [Plain [Str "Pass/Fail"]], Cell ("", [], []) AlignDefault (RowSpan 0) (ColSpan 0) [Plain [Str "Action"]]]]) [(TableBody ("", [], []) (RowHeadColumns 0) [] [Row ("", [], []) [Cell ("", [], []) AlignDefault (RowSpan 0) (ColSpan 0) [Plain [Str "+/-0.5mm or better"]], Cell ("", [], []) AlignDefault (RowSpan 0) (ColSpan 0) [Plain [Str "PASS"]], Cell ("", [], []) AlignDefault (RowSpan 0) (ColSpan 0) [Plain [Str "No adjustment needed"]]], Row ("", [], []) [Cell ("", [], []) AlignDefault (RowSpan 0) (ColSpan 0) [Plain [Str "+/-0.5-1mm"]], Cell ("", [], []) AlignDefault (RowSpan 0) (ColSpan 0) [Plain [Str "MARGINAL"]], Cell ("", [], []) AlignDefault (RowSpan 0) (ColSpan 0) [Plain [Str "Document and monitor"]]], Row ("", [], []) [Cell ("", [], []) AlignDefault (RowSpan 0) (ColSpan 0) [Plain [Str ">+/-1mm"]], Cell ("", [], []) AlignDefault (RowSpan 0) (ColSpan 0) [Plain [Str "FAIL"]], Cell ("", [], []) AlignDefault (RowSpan 0) (ColSpan 0) [Plain [Str "Adjust flow/calibration"]]]])] (TableFoot ("", [], []) []), HorizontalRule, Header 4 ("environmental-diagnostics", ["unnumbered", "unlisted"], []) [Str "Environmental Diagnostics"], Para [Strong [Str "When quality varies between prints:"]], Para [Strong [Str "Check Conditions:"]], BulletList [[Plain [Str "\9744", Space, Str "Room temperature stable (+/-5C?)"]], [Plain [Str "\9744", Space, Str "Humidity reasonable (30-60%?)"]], [Plain [Str "\9744", Space, Str "No drafts from windows/AC near printer"]], [Plain [Str "\9744", Space, Str "Consistent vibration level (no external impact)"]], [Plain [Str "\9744", Space, Str "Same filament spool/batch used"]], [Plain [Str "\9744", Space, Str "Same slicer settings applied"]]], Para [Strong [Str "Environmental Log:"]], CodeBlock ("", ["plaintext"], []) "Date:     Time:     Temp: C    Humidity: %
Print Duration:     Result Quality: Poor/Fair/Good/Excellent
Notes: 
", HorizontalRule, Header 4 ("troubleshooting-decision-tree", ["unnumbered", "unlisted"], []) [Str "Troubleshooting Decision Tree"], Para [Strong [Str "Start here for systematic diagnosis:"]], CodeBlock ("", ["plaintextv"], []) "+---- Printer won't start?
...
", HorizontalRule, Header 4 ("diagnostic-report-template", ["unnumbered", "unlisted"], []) [Str "Diagnostic Report Template"], Para [Strong [Str "Use when seeking help:"]], CodeBlock ("", ["plaintext"], []) "DIAGNOSTIC REPORT
================
...
", HorizontalRule, Para [Strong [Str "Last Diagnostic Date:"], SoftBreak, Strong [Str "Issue Resolved:"], LineBreak, Strong [Str "Diagnostic Performed By:"]]]