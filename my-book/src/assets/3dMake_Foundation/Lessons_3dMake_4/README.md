...
- Use AI tools for model inspection and improvement
- Interpret multimodal feedback (visual, textual, mathematical)
- Implement improvements based on AI suggestions
- Create robust, testable designs
