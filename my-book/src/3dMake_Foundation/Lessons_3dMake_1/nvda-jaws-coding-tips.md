...
NV Access. (2024). *NVDA user guide*. [https://www.nvaccess.org/files/nvda/documentation/userGuide.html](https://www.nvaccess.org/files/nvda/documentation/userGuide.html)

Freedom Scientific. (2024). *JAWS for Windows help*. [https://support.freedomscientific.com/Content/Documents/Manuals/JAWS/JAWS-Screen-Reader-Help.pdf](https://support.freedomscientific.com/Content/Documents/Manuals/JAWS/JAWS-Screen-Reader-Help.pdf)

Microsoft. (2024). *Visual Studio Code accessibility*. [https://code.visualstudio.com/docs/editor/accessibility](https://code.visualstudio.com/docs/editor/accessibility)
