...
Materials
- A computer with Git Bash installed (install via [https://git-scm.com/](https://git-scm.com/))
...
## References
- Git for Windows. (2024). *Git Bash*. [https://gitforwindows.org/](https://gitforwindows.org/)
