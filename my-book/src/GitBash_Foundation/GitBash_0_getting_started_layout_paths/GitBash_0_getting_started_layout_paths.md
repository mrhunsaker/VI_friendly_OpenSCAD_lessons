...
- Understand Unix-style path notation (`/`, `~`, `.`, `..`)
- Use tab completion to navigate quickly
- Understand how Git Bash paths relate to Windows paths
...
## Path Conversion: Windows to Git Bash

| Windows Path              | Git Bash Path             | What It Means    |
|---------------------------|---------------------------|------------------|
| `C:\Users\Name`           | `/c/Users/Name`           | User home folder |
| `C:\Users\Name\Documents` | `/c/Users/Name/Documents` | Documents folder |
| `C:\Program Files`        | `/c/Program Files`        | Program files    |
| `D:\`                     | `/d/`                     | D: drive         |

## Quiz - Lesson GitBash.0

1. What is a path?
2. What does `~` mean in Git Bash?
...
11. What does `/c/` mean at the start of a path?
12. How do you navigate to a folder in your Windows Documents folder from Git Bash?
13. Explain what the prompt shows about your current state.
...
4. Navigate to a Windows folder path using the Git Bash equivalent.
...
7. Create a script that prints your current path; run it from different locations.
8. Investigate special paths (e.g., `~/`, `$HOME`); write down what each contains and when you'd use them.
9. Compare absolute vs. relative paths by navigating to the same folder using each method.
...
- GNU. (2024). *Bash Manual*. https://www.gnu.org/software/bash/manual/
- Git SCM. (2024). *Git Bash documentation*. https://git-scm.com/book/en/v2
- Linux Foundation. (2024). *The Linux Command Line*. https://linuxcommand.org/
