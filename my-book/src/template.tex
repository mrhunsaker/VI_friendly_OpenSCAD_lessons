% ---------------------------------------------------------------------------
% Replaces $passoptions.latex()$ which is only available in Pandoc ≥ 3.2
% and is absent from many CI-installed Pandoc versions.
% These are the PassOptions calls Pandoc would normally inject via that partial.
% ---------------------------------------------------------------------------
