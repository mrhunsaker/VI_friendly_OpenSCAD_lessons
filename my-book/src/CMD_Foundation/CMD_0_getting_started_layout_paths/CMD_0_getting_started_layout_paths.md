...
**Learning Objectives**
- Open Command Prompt and locate the prompt
...
6. True or False: On Windows, paths use backslashes (\) and Command Prompt doesn't accept forward slashes (/).
...
11. What does `C:\` mean in a path, and how would you navigate there?
...
4. Try `cd` into a folder whose name contains spaces; observe how it's handled.
...
8. Investigate special paths (e.g., `C:\Users\%USERNAME%\`); write down what each contains and when you'd use them.
...
- Microsoft. (2024). *Command line reference*. https://docs.microsoft.com/en-us/windows-server/administration/windows-commands/windows-commands-glossary
- Microsoft. (2024). *Using the cd command*. https://docs.microsoft.com/en-us/windows-server/administration/windows-commands/cd

## Helpful Resources

- [Windows Command Reference](https://docs.microsoft.com/en-us/windows-server/administration/windows-commands/windows-commands-glossary)
